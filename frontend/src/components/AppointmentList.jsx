...
import { Edit, Trash2, MapPin, Clock, Plane, Calendar, CheckCircle, XCircle, Copy, DollarSign } from 'lucide-react';
        ...
        return (
          ...
          >
            <CardContent className="p-6">
              ...
              {(appointment.flight_info || appointment.luggage_passengers || appointment.amount > 0 || appointment.other_details) && (
